		<?php
			...
			No Anggota :
					<div class="form-group">
						<label class="control-label col-sm-0" for="id_anggota"></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" value="<?=$_SESSION['id_anggota']?>" disabled>
						</div>
					</div>

			Nama :
					<div class="form-group">
						<label class="control-label col-sm-0" for="nama"></label>
						<div class="col-sm-10">
			...
			id Anggota :
					<div class="form-group">
						<label class="control-label col-sm-0" for="sisa_pinjaman"></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" value="jal"> 
						</div>
			</div>
			
			Tanggal Pinjam :
					<div class="form-group">
						<label class="control-label col-sm-0" for="angsuran_bulanan"></label>
						<div class="col-sm-10">
			...
			Tanggal Kembali :
					<div class="form-group">
						<label class="control-label col-sm-0" for="denda"></label>
						<div class="col-sm-10">
			...
			Terlambat :
					<div class="form-group">
						<label class="control-label col-sm-0" for="total_bayar"></label>
						<div class="col-sm-10">
			...
			Total Denda :
					<div class="form-group">
						<label class="control-label col-sm-0" for="bayar_angsuran"></label>
						<div class="col-sm-10">
